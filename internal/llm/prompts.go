...
const systemPromptPTBR = `Você é um assistente em português brasileiro integrado ao WhatsApp para uso da plataforma Clicksign.
...
// SystemPrompt returns the canonical pt-BR system prompt.
